...
myStack.push(0);
myStack.pop();
console.log(`Pop ${myStack.util('Apples')} times`);


/*
Typically I wouldn't need to actually write all the methods for the Stack again
Ideally I would use inhertance
*/
...
MinStack.prototype.contains = function(value) {
  for (let i = 0 ; i < this._count ; i++) {
    if (this._storage[i] === value) {
      console.log(`Your search for:${value} has been found in index ${i}`);
      return true;
...
MinStack.prototype.util = function(value){
    let numPops = 0;
